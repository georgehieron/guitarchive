...
/******/ 			var chunk = require("./" + ({"1":"pages/_brand/_slug","2":"pages/index"}[chunkId]||chunkId) + ".js");
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ":root{--color-base:#262626;--color-text:#f6e9e9;--color-primary:#ffff47;--color-shade:#1d1d1d;--color-accent:#5f8cf0;--space:max(3vw,2rem);--border-radius:0;--box-shadow:0 0 0 0.125rem;--transition:0.25s ease}.focus-visible,:focus-visible{outline:.125rem dotted #ffff47;outline:.125rem dotted var(--color-primary);outline-offset:.1rem}::-moz-selection{color:#262626;color:var(--color-base);background-color:#ffff47;background-color:var(--color-primary)}::selection{color:#262626;color:var(--color-base);background-color:#ffff47;background-color:var(--color-primary)}body{background-color:#262626;background-color:var(--color-base);color:#f6e9e9;color:var(--color-text);font-family:\"Atkinson Hyperlegible\",sans-serif;font-weight:400;letter-spacing:.05ch}h1{display:block;width:100%;letter-spacing:clamp(0,1vw,.625rem);font-size:clamp(1.8rem,3.6vw,3.4rem);text-align:center;text-transform:uppercase;background-color:#1d1d1d;background-color:var(--color-shade);padding:0 .1em}body,input,select{color:#f6e9e9;color:var(--color-text)}a{color:#ffff47;color:var(--color-primary);transition:color .25s ease;transition:var(--transition) color}a:focus,a:hover{color:#5f8cf0;color:var(--color-accent)}.btn,button{color:#262626;color:var(--color-base);background-color:#ffff47;background-color:var(--color-primary);border-color:#ffff47;border-color:var(--color-primary);font-size:1.1em;letter-spacing:.25ch;padding:.25em 1em;text-transform:uppercase}.btn:active,button:active{opacity:.9}.btn.focus-visible,.btn:focus-visible,.btn:hover,button.focus-visible,button:focus-visible,button:hover{background-color:#5f8cf0;background-color:var(--color-accent);border-color:#5f8cf0;border-color:var(--color-accent)}.image--notfound{background-color:#ffff47!important;background-color:var(--color-primary)!important}.image--notfound:before,.image--notfound img:before{color:#1d1d1d!important;color:var(--color-shade)!important}.wrapper{max-width:90rem;margin-left:auto;margin-right:auto}.padded{padding:calc(max(3vw, 2rem)/2) max(3vw,2rem);padding:calc(var(--space)/2) var(--space)}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
const _088dacd3 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 2).then(__webpack_require__.bind(null, 34)));

const _c8dbf05c = () => interopDefault(__webpack_require__.e(/* import() | pages/_brand/_slug */ 1).then(__webpack_require__.bind(null, 35)));
...
var css_reset = __webpack_require__(17);
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {
      ...
      "script": [{
        "hid": "gf-script",
        "innerHTML": "(function(){var l=document.createElement('link');l.rel=\"stylesheet\";l.href=\"https:\u002F\u002Ffonts.googleapis.com\u002Fcss2?family=Atkinson+Hyperlegible:wght@400;700&display=swap\";document.querySelector(\"head\").appendChild(l);})();"
      }],
      "noscript": [{
        "hid": "gf-noscript",
        "innerHTML": "\u003Clink rel=\"stylesheet\" href=\"https:\u002F\u002Ffonts.googleapis.com\u002Fcss2?family=Atkinson+Hyperlegible:wght@400;700&display=swap\"\u003E"
      }],
